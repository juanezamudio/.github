...
- 🛒 [**urban-oasis-app**](https://github.com/juanezamudio/urban-oasis-app) — A mobile-first Progressive Web App (PWA) for the Urban Oasis Project, enabling efficient farmers market POS functionality.
- 🚨 [**migralert**](https://github.com/juanezamudio/migralert) — A community-powered PWA providing real-time safety alerts and information about immigration enforcement activity.
...
- 📧 [**inbox-zero**](https://github.com/juanezamudio/inbox-zero) — An open-source AI email assistant that organizes inboxes, pre-drafts replies, and tracks follow-ups to achieve inbox zero.
